...
import com.ict1009.ahg.gameplay.Animal;
import com.ict1009.ahg.gameplay.Entity;
import com.ict1009.ahg.gameplay.Explosion;
import com.ict1009.ahg.gameplay.Player;
...
//        animalTextures = new TextureRegion[]{bearTextureRegion, elephantTextureRegion, lionTextureRegion, gorillaTextureRegion, camelTextureRegion};
    ...
    private void spawnEnemyAnimals(float deltaTime) {
        ...
        if (enemySpawnTimer > timeBetweenEnemySpawns && mobs.size() < 10) {
            ...
            mobs.add(new Animal(48, 5,
                    20, 20,
                    generator.nextFloat() * (WORLD_WIDTH - 10) + 5, WORLD_HEIGHT + 30,
                    0.8f, 4, 70, .8f,
